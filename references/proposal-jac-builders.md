# JAC Builders — Strategic Paid Advertising Plan (Orlando + Tampa Bay)

**Prepared for:** Sean and the JAC leadership team
**Prepared by:** Hey Aaron! Marketing
**Date:** August 14, 2026
**Version:** 3 (conservative — accounts for 2 months of stalled LSA effort; Google Search Ads primary)

**Goal:** Predictable, growing lead flow across both metros using Google Search Ads as the primary paid channel, with a parallel workstream continuing to fight for Local Services Ads and the new Performance Max pay-per-lead campaign type as *possible* upside — not as a planned dependency.
...
Instead, the base plan funds **Google Search Ads** as the workhorse channel in both metros, priced at the full non-branded auction rate (JAC pays $475–675 per lead, depending on metro, at conservative assumptions). Our team continues in parallel to (1) troubleshoot the existing LSA accounts through Google's Tier-2 escalation path and (2) prepare JAC for Google's new **Performance Max pay-per-lead** campaign type (the "New Method" that's replacing LSA through late 2026 / 2027). If either produces working lead flow at the industry benchmark ($80–150 per lead for roofing), the average cost per lead drops meaningfully. If neither ever does, the plan still holds — JAC just pays full Google Search Ads pricing throughout.

**What that means, month 12:**
- **Base case (Search Ads only, LSA stays broken):** ~22–38 leads/month at $310–470 per lead, ~$10–13K/month ad spend
- **Upside case (LSA or PMax pay-per-lead comes online at some point in 2026-27):** ~40–75 leads/month at $200–320 per lead for similar ad spend
- **12-month total, base case:** ~180–300 leads on $100–125K ad spend, at an average of $340–540 per lead
...
3. **The industry-benchmark LSA cost per lead ($80–150) only applies once the account is actually serving.** JAC is not near that today. Reserving budget against those numbers would be irresponsible.
4. **Google Search Ads carries the plan.** Search Ads is a mature, well-instrumented, reliable channel we know we can turn on in week 1 and predict cost per lead for. That's the workhorse.
...
|---|---|---|---|---|
| **Tampa Bay** | 10 | 5,700 | ~42,800 | ~640 clicks *(30% impression share × 5% CTR)* |
| **Orlando (Central FL)** | 11 | 4,540 | ~32,400 | ~485 clicks *(30% impression share × 5% CTR)* |

Both metros have plenty of demand. **The bottleneck is cost per click × conversion rate, not searches.**

### Non-branded Search cost per click & cost per lead

| Metro | CPC @ position 3–4 | CPC @ position #1 | Cost per lead @ position 3–4 |
|---|---|---|---|
| **Tampa Bay** | $27 | $94 | ~$675 |
| **Orlando** | $19 | $63 | ~$475 |

Cost per lead assumes **3% click-to-lead conversion for the first 90 days** (before landing-page optimization) and 4% thereafter. Home-services median CVR is 3.7%; roofing sits at the low end because the decision requires trust proofs (portfolio, insurance, referrals). We stay conservative.

We recommend **position 3–4 as the default posture** in both metros. Owning #1 on head terms roughly triples cost per click for a modest volume gain and pushes cost per lead past $1,500 in Tampa — bad economics unless the auction is soft. Revisit only when conversion actuals prove justification.
...
Sequenced in the order we deploy them. **Google Search Ads is the only channel we financially plan around; the LSA and New Method workstreams are opportunistic.**

| Priority | Channel | Metro | Role | Typical cost per lead | Certainty |
|---|---|---|---|---|---|
| 1 | **Google Search Ads (branded)** | Both | Capture existing brand demand — cheap, high intent | $10–25 | High |
| 2 | **Google Search Ads (non-branded roofing)** | Both | The workhorse — carries the plan's lead volume | $400–675 first 90 days, $300–500 thereafter | High |
| 3 | **Google Business Profile organic + review generation** | Both | Feeds LSA option value + organic map-pack leads | ~$0 (operational cost only) | Medium — depends on JAC's ask-at-completion discipline |
...
| 5 | **Performance Max pay-per-lead (New Method)** | Both, as Google migrates JAC's account | Prepare + test aggressively when JAC's account migrates | $80–150/lead if it works | Unknown — depends on whether migration resolves the underlying LSA issue |
...
This is what JAC should budget against. If LSA or PMax pay-per-lead comes online during the plan (see upside case below), it augments the numbers — but nothing in this table depends on it working.

| Month | Focus | Ad spend | Est. leads | Cost per lead |
|---|---|---:|---:|---:|
| **M1** | Setup: tracking, conversion mapping, branded + non-branded Search live, landing pages audited, LSA escalation continues | $3K–5K | 3–8 | $500–800 |
| **M2** | Search Ads dial-in (Quality Score work, negative keywords, ad copy tests) | $6K–9K | 10–18 | $450–700 |
| **M3** | Landing-page conversion-rate project (target: get from 3% → 4%) | $8K–11K | 14–25 | $400–600 |
| **M4** | Non-branded Search expansion; branded Search cranked up | $9K–12K | 16–28 | $370–570 |
| **M5–6** | Expand keyword base, test broader match with tight audiences, budget scaling | $10K–13K | 20–33 | $340–520 |
| **M7–9** | If JAC's account migrates to PMax pay-per-lead: aggressive testing; otherwise steady state | $10K–13K | 22–36 | $320–490 |
| **M10–12** | Steady state; annual review; contingency budget for storm-season variance | $10K–13K | 22–38 | $310–470 |

**12-month base-case totals:** ~$100K–125K ad spend, **180–300 leads**, average **$340–540 per lead**.

**Interpret the ranges honestly:** the low end of each range assumes we hit conservative CVR (3–4%) and no unexpected roadblocks. The high end assumes ~30% variance from unexpected issues (landing page conversion rate stuck at 3%, storm-season CPC spikes, account learning delays, seasonal demand dips, an unexpected policy audit, etc.). Roofing paid search in FL has this much variance. We prefer to price it in up front.

### Upside case (if LSA or PMax pay-per-lead ever produces leads at benchmark)

Not a promise. A contingency. If in some month the LSA account (Tampa first, since JAC's review moat is there) or the new PMax pay-per-lead campaign starts serving at industry-benchmark $80–150 per lead:

- **Add 15–40 leads/month per unlocked metro** at ~$100 per lead
- **Overall cost per lead drops toward $200–320** (from the base $310–470)
- **Total 12-month leads shift toward 350–550** (from base 180–300)
...
- Week 3: Landing-page conversion-rate baseline measured (target: measure real, not assume).
- Week 4: First lead reports out; review-generation ask flow deployed at both offices.

**Month 3 — Rhythm established**
- Landing-page conversion rate ≥ 4% verified (from measured baseline).
- Answer rate ≥ 95% on all lead calls, verified via call-tracking records.
- Both metros' Search Ads producing consistent lead flow within the projected cost per lead band.
- Monthly LSA / New Method status update: still stuck, or progressing? Documented for JAC.

**Month 6 — Efficiency threshold**
- Search Ads cost per lead crosses $450 downward for the first time.
...
- Steady-state performance report: actual cost per lead vs projected, actual leads vs projected, unexpected roadblocks encountered, dollars spent on troubleshooting vs producing.
...
| **Landing-page conversion rate stays at 3%** despite refresh work | Cost per lead 30–40% higher than projected | Month-3 landing-page project explicitly targets improvement; measure before and after with a control. If still stuck at 3% by month 6, deeper CRO project (extra scope). | Partial — month 3 refresh is included; second-pass CRO would be new scope |
| **Storm season CPC spikes 40–70%** (hurricane season, hail events) | Cost per lead climbs 20–30% for 4–8 weeks | Budget headroom in months 5–8. Do not judge account performance during named-storm weeks. | ✅ (contingency built into ranges) |
| **Google Ads account learning delays** (2–4 weeks of erratic delivery on new campaigns) | Month 1–2 look worse than plan | Priced in — month 1 cost per lead band is deliberately wide. | ✅ |
...
| **Unexpected roadblocks we haven't anticipated** | Timelines slip, spend re-allocates | ~15% contingency implicit in the cost-per-lead / spend ranges. This is why the ranges are wide, not tight. | ✅ |
...
5. **Call-tracking decision** — CallRail or equivalent ($50–100/mo). Non-negotiable for cost-per-lead attribution.
...
9. **Target monthly lead volume** — the plan assumes "as many as JAC can absorb." If Sean has a specific number (e.g. 30/mo), we cap spend accordingly.
10. **Average job value + close rate** — lets us convert monthly reports from cost per lead to cost per booked revenue.
...
- **Volume-weighted:** Each keyword's suggested bid is weighted by its search volume, so the reported CPC reflects the typical auction, not the priciest term.
...
- **Result — first 90 days:** Tampa $27 / 3% = **~$900 per lead**. Orlando $19 / 3% = **~$630 per lead**. **After 90 days at 4% CVR:** Tampa ~$675, Orlando ~$475. Weighted over 12 months, the plan lands in the $340–540 range as account maturity + landing-page work compound.

### 4. LSA / Performance Max pay-per-lead cost per lead (upside case only)
...
- **JAC's current actual cost per lead** on any channel — replaces our industry benchmarks after month 1 of measurement.
- **JAC's actual close rate and job value** — shifts reporting from cost per lead to cost per booked job to ROI on ad spend.
- **JAC's landing-page conversion baseline** — measured in week 1. All cost-per-lead projections assume 3% → 4% CVR; JAC's actuals may be higher or (more likely for a legacy WordPress site) lower.
...
1. **Target monthly lead volume**: is JAC targeting a specific number (e.g. 30/mo), or "as many as we can absorb"? Shapes the budget curve.
2. **Current ad spend and channels**: what's JAC running today (Search, HomeAdvisor / Angi, other agencies)? Roughly what monthly spend?
...
## Appendix — data pull details

| Data set | Endpoint | Pulled | Cost |
|---|---|---:|---:|
| Google Ads search volumes (28 cities × 15 keywords) | `keywords_data/google_ads/search_volume/live` | 2026-08-14 | ~$2.80 |
| DMA-level keyword-universe expansion (2 metros) | `keywords_data/google_ads/keywords_for_keywords/live` | 2026-08-14 | ~$0.20 |
| Client Google Business Profile lookups (2) | `business_data/google/my_business_info/live` | 2026-08-14 | ~$0.04 |
...
*Prepared by Hey Aaron! Marketing · hello@aaron.chat · [aaron.chat](https://aaron.chat)*
